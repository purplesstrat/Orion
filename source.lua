...
function OrionLib:MakeWindow(WindowConfig)
                ...
                ),
                {
                    ...
                    AddThemeObject(
                        SetProps(
                            MakeElement(
                                "Label",
                                "This part of the script is locked to Sirius Premium users.",
                                12
                            ),
                            {
    ...
    OrionLib:MakeNotification(
        {
            Name = "UI Library Upgraded",
            Content = "The UI Library has been updated to its latest modded version.",
            Time = 5
        }
    )
